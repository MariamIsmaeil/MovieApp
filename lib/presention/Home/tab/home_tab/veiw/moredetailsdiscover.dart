...
class MoreDetailsDiscover extends StatefulWidget {
  final Discoverentity dis;
  int? index;

  MoreDetailsDiscover({Key? key, this.index,required this.dis}) : super(key: key);

  @override
  State<MoreDetailsDiscover> createState() => _MoreDetailsSimilarState();
}

class _MoreDetailsSimilarState extends State<MoreDetailsDiscover> {
  @override
                        ...
                        child: Column(
                          children: [
                            Stack(
                              children: [
                                Image.network(
                                  "https://image.tmdb.org/t/p/w500/${widget.dis.posterPath}",
                                  fit: BoxFit.fill,
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                  Text('''${widget.dis.overview}'''??"",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white)),
                                  Row(
                                    children: [
                                      Icon(Icons.star,color: Colors.amber,size: 24.sp,),
                                      SizedBox(width: 10.w,),
                                      Text("${widget.dis.voteAverage}",style: TextStyle(color: Colors.white,fontSize: 24.sp)),
                                    ],
                                  )
                                ],)),
                              ],
