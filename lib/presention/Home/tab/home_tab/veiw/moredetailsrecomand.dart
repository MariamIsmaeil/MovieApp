                      ...
                      child: Column(
                        children: [
                          Stack(
                            children: [
                              Image.network(
                                "https://image.tmdb.org/t/p/w500/${reco.posterPath}",
                                fit: BoxFit.fill,
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                                Text('''${reco.overview}'''??"",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white)),
                                Row(
                                  children: [
                                    Icon(Icons.star,color: Colors.amber,size: 24.sp,),
                                    SizedBox(width: 10.w,),
                                    Text("${reco.voteAverage}",style: TextStyle(color: Colors.white,fontSize: 24.sp)),
                                  ],
                                )
                              ],)),
                            ],
